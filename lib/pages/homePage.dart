...
class _HomeState extends State<Home> {
  ...
  ontheload()async{
    ...
    @override
void dispose() {
    _scrollController.dispose(); // Dispose the scroll controller to avoid memory leaks
    super.dispose();
  }
initState() {
    ontheload();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Column(    //Name,Detail and 4 catoegory
    ...
    Container(
      ...
      child: Scrollbar(
        ...
        scrollbarOrientation: ScrollbarOrientation.left, // Scrollbar on the left
        thickness: 8.0,
        
        thumbVisibility: true, // Always show the thumb
        interactive: true,
        child: SingleChildScrollView(
          controller: _scrollController, // Attach the controller to sync scrolling
          child: Column(
            children: [
              SizedBox(
      ...
      children: [
        GestureDetector(
          onTap: () async{
            ...
            burger = false;
            salaad = false;
            fooditemStream =await DataBaseMethods().getFoodItem("Pizza") as Stream?;
            setState(() {});
          },
          child: Material(
            elevation: 4,
        ...
        GestureDetector(
          onTap: ()async {
            ...
            burger = false;
            salaad = false;
            fooditemStream =await DataBaseMethods().getFoodItem("Ice-cream") as Stream?;
            setState(() {});
          },
          child: Material(
            elevation: 4,
        ...
        GestureDetector(
          onTap: () async{
            ...
            burger = false;
            salaad = true;
            fooditemStream =await DataBaseMethods().getFoodItem("Salad") as Stream?;
            setState(() {});
          },
          child: Material(
            elevation: 4,
